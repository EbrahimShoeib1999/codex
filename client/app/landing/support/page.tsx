...
export default function SupportPage() {
  ...
  function onSubmit(values: z.infer<typeof supportFormSchema>) {
    toast({
      ...
      description: "This is a demo form. Your support ticket has not been submitted. Please contact us directly at support@codextech.com.",
      duration: 9000,
    });
    console.log(values);
    form.reset();
                      ...
                      <Button 
                        ...
                        onClick={() => {
                          toast({
                            ...
                            description: "This feature is not yet implemented. Please contact us via email or phone.",
                          });
                        }}
                      >
